...
void OBJObject::draw(GLuint shaderProgram)
{
		...
		glBindVertexArray(VAO);
		if(dot == 0) glDrawElements(GL_TRIANGLES, (GLsizei)tvertices.size(), GL_UNSIGNED_INT, 0);
		else glDrawElements(GL_LINES, (GLsizei)tvertices.size(), GL_UNSIGNED_INT, 0);
